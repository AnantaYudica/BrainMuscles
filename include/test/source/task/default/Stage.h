...
{
	if (*this == StatusFlagsType::not_test && IsBegin())
	{
		SetNotTest();
		return true;
	}
...
{
	if (*this == StatusFlagsType::not_completed && IsNotTest())
	{
		SetPreTest();
		return true;
	}
...
{
	if (*this == StatusFlagsType::not_completed
		&& (IsNotTest() || IsPreTest()))
	{
		SetTest();
		return true;
...
{
	if (*this == StatusFlagsType::pass && IsTest())
	{
		SetPostTest();
		return true;
	}
